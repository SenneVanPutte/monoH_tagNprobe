...
for(int i=0; i<systematicVar.size();i++)
{
   ...
   double pt_bins_Mu37_TkMu27_leg1[17]= {0,10,20,30,34,35,36,37,38,39,40,42,45,50,60,100,200};
   double pt_bins_Mu37_TkMu27_leg2[17]= {0,10,20,24,25,26,27,28,29,30,32,35,40,50,60,100,200};
...
//
//// MonoHiggs
//   TH1F *h_Mu17_pt_total = new TH1F("Mu17_pt_total","Mu17_pt",16,pt_bins_Mu17);
//   TH1F *h_Mu17_eta_total = new TH1F("Mu17_eta_total","Mu17_eta",13,eta_bins);
//   TH2F *h_Mu17_pt_eta_total = new TH2F("Mu17_pt_eta_total","Mu17_pt_eta",13,eta_bins,16,pt_bins_Mu17);
//   TH1F *h_Mu17_pt_pass = new TH1F("Mu17_pt_pass","Mu17_pt",16,pt_bins_Mu17);
//   TH1F *h_Mu17_eta_pass = new TH1F("Mu17_eta_pass","Mu17_eta",13,eta_bins);
//   TH2F *h_Mu17_pt_eta_pass = new TH2F("Mu17_pt_eta_pass","Mu17_pt_eta",13,eta_bins,16,pt_bins_Mu17);
//
//   h_Mu17_pt_total->Sumw2();
//   h_Mu17_eta_total->Sumw2();
//   h_Mu17_pt_eta_total->Sumw2();
//   h_Mu17_pt_pass->Sumw2();
//   h_Mu17_eta_pass->Sumw2();
//   h_Mu17_pt_eta_pass->Sumw2();
   ...
   TH1F *h_Mu37_TkMu27_leg1_pt_total = new TH1F("Mu37_TkMu27_leg1_pt_total","Mu37_TkMu27_leg1_pt",16,pt_bins_Mu37_TkMu27_leg1);
   TH1F *h_Mu37_TkMu27_leg1_eta_total = new TH1F("Mu37_TkMu27_leg1_eta_total","Mu37_TkMu27_leg1_eta",13,eta_bins);
   TH2F *h_Mu37_TkMu27_leg1_pt_eta_total = new TH2F("Mu37_TkMu27_leg1_pt_eta_total","Mu37_TkMu27_leg1_pt_eta",13,eta_bins,16,pt_bins_Mu37_TkMu27_leg1);
   TH1F *h_Mu37_TkMu27_leg1_pt_pass = new TH1F("Mu37_TkMu27_leg1_pt_pass","Mu37_TkMu27_leg1_pt",16,pt_bins_Mu37_TkMu27_leg1);
   TH1F *h_Mu37_TkMu27_leg1_eta_pass = new TH1F("Mu37_TkMu27_leg1_eta_pass","Mu37_TkMu27_leg1_eta",13,eta_bins);
   TH2F *h_Mu37_TkMu27_leg1_pt_eta_pass = new TH2F("Mu37_TkMu27_leg1_pt_eta_pass","Mu37_TkMu27_leg1_pt_eta",13,eta_bins,16,pt_bins_Mu37_TkMu27_leg1);

   h_Mu37_TkMu27_leg1_pt_total->Sumw2();
   h_Mu37_TkMu27_leg1_eta_total->Sumw2();
   h_Mu37_TkMu27_leg1_pt_eta_total->Sumw2();
   h_Mu37_TkMu27_leg1_pt_pass->Sumw2();
   h_Mu37_TkMu27_leg1_eta_pass->Sumw2();
   h_Mu37_TkMu27_leg1_pt_eta_pass->Sumw2();

   TH1F *h_Mu37_TkMu27_leg2_pt_total = new TH1F("Mu37_TkMu27_leg2_pt_total","Mu37_TkMu27_leg2_pt",16,pt_bins_Mu37_TkMu27_leg2);
   TH1F *h_Mu37_TkMu27_leg2_eta_total = new TH1F("Mu37_TkMu27_leg2_eta_total","Mu37_TkMu27_leg2_eta",13,eta_bins);
   TH2F *h_Mu37_TkMu27_leg2_pt_eta_total = new TH2F("Mu37_TkMu27_leg2_pt_eta_total","Mu37_TkMu27_leg2_pt_eta",13,eta_bins,16,pt_bins_Mu37_TkMu27_leg2);
   TH1F *h_Mu37_TkMu27_leg2_pt_pass = new TH1F("Mu37_TkMu27_leg2_pt_pass","Mu37_TkMu27_leg2_pt",16,pt_bins_Mu37_TkMu27_leg2);
   TH1F *h_Mu37_TkMu27_leg2_eta_pass = new TH1F("Mu37_TkMu27_leg2_eta_pass","Mu37_TkMu27_leg2_eta",13,eta_bins);
   TH2F *h_Mu37_TkMu27_leg2_pt_eta_pass = new TH2F("Mu37_TkMu27_leg2_pt_eta_pass","Mu37_TkMu27_leg2_pt_eta",13,eta_bins,16,pt_bins_Mu37_TkMu27_leg2);

   h_Mu37_TkMu27_leg2_pt_total->Sumw2();
   h_Mu37_TkMu27_leg2_eta_total->Sumw2();
   h_Mu37_TkMu27_leg2_pt_eta_total->Sumw2();
   h_Mu37_TkMu27_leg2_pt_pass->Sumw2();
   h_Mu37_TkMu27_leg2_eta_pass->Sumw2();
   h_Mu37_TkMu27_leg2_pt_eta_pass->Sumw2();
...
// HLT IsoMu27
   TH1F *h_orTag_IsoMu27_pt_total = new TH1F("orTag_IsoMu27_pt_total","orTag_IsoMu27_pt",16,pt_bins_IsoMu27);
   TH1F *h_orTag_IsoMu27_eta_total = new TH1F("orTag_IsoMu27_eta_total","orTag_IsoMu27_eta",13,eta_bins);
   TH2F *h_orTag_IsoMu27_pt_eta_total = new TH2F("orTag_IsoMu27_pt_eta_total","orTag_IsoMu27_pt_eta",13,eta_bins,16,pt_bins_IsoMu27);
   TH1F *h_orTag_IsoMu27_pt_pass = new TH1F("orTag_IsoMu27_pt_pass","orTag_IsoMu27_pt",16,pt_bins_IsoMu27);
   TH1F *h_orTag_IsoMu27_eta_pass = new TH1F("orTag_IsoMu27_eta_pass","orTag_IsoMu27_eta",13,eta_bins);
   TH2F *h_orTag_IsoMu27_pt_eta_pass = new TH2F("orTag_IsoMu27_pt_eta_pass","orTag_IsoMu27_pt_eta",13,eta_bins,16,pt_bins_IsoMu27);

   h_orTag_IsoMu27_pt_total->Sumw2();
   h_orTag_IsoMu27_eta_total->Sumw2();
   h_orTag_IsoMu27_pt_eta_total->Sumw2();
   h_orTag_IsoMu27_pt_pass->Sumw2();
   h_orTag_IsoMu27_eta_pass->Sumw2();
   h_orTag_IsoMu27_pt_eta_pass->Sumw2();
...
// MonoHiggs
   TH1F *h_orTag_Mu50_pt_total = new TH1F("orTag_Mu50_pt_total","orTag_Mu50_pt",16,pt_bins_IsoMu27orMu50);
   TH1F *h_orTag_Mu50_eta_total = new TH1F("orTag_Mu50_eta_total","orTag_Mu50_eta",13,eta_bins);
   TH2F *h_orTag_Mu50_pt_eta_total = new TH2F("orTag_Mu50_pt_eta_total","orTag_Mu50_pt_eta",13,eta_bins,16,pt_bins_IsoMu27orMu50);
   TH1F *h_orTag_Mu50_pt_pass = new TH1F("orTag_Mu50_pt_pass","orTag_Mu50_pt",16,pt_bins_IsoMu27orMu50);
   TH1F *h_orTag_Mu50_eta_pass = new TH1F("orTag_Mu50_eta_pass","orTag_Mu50_eta",13,eta_bins);
   TH2F *h_orTag_Mu50_pt_eta_pass = new TH2F("orTag_Mu50_pt_eta_pass","orTag_Mu50_pt_eta",13,eta_bins,16,pt_bins_IsoMu27orMu50);
   ...
   TH1F *h_orTag_IsoMu27orMu50_pt_total = new TH1F("orTag_IsoMu27orMu50_pt_total","orTag_IsoMu27orMu50_pt",16,pt_bins_IsoMu27orMu50);
   TH1F *h_orTag_IsoMu27orMu50_eta_total = new TH1F("orTag_IsoMu27orMu50_eta_total","orTag_IsoMu27orMu50_eta",13,eta_bins);
   TH2F *h_orTag_IsoMu27orMu50_pt_eta_total = new TH2F("orTag_IsoMu27orMu50_pt_eta_total","orTag_IsoMu27orMu50_pt_eta",13,eta_bins,16,pt_bins_IsoMu27orMu50);
   TH1F *h_orTag_IsoMu27orMu50_pt_pass = new TH1F("orTag_IsoMu27orMu50_pt_pass","orTag_IsoMu27orMu50_pt",16,pt_bins_IsoMu27orMu50);
   TH1F *h_orTag_IsoMu27orMu50_eta_pass = new TH1F("orTag_IsoMu27orMu50_eta_pass","orTag_IsoMu27orMu50_eta",13,eta_bins);
   TH2F *h_orTag_IsoMu27orMu50_pt_eta_pass = new TH2F("orTag_IsoMu27orMu50_pt_eta_pass","orTag_IsoMu27orMu50_pt_eta",13,eta_bins,16,pt_bins_IsoMu27orMu50);

   h_orTag_IsoMu27orMu50_pt_total->Sumw2();
   h_orTag_IsoMu27orMu50_eta_total->Sumw2();
   h_orTag_IsoMu27orMu50_pt_eta_total->Sumw2();
   h_orTag_IsoMu27orMu50_pt_pass->Sumw2();
   h_orTag_IsoMu27orMu50_eta_pass->Sumw2();
   h_orTag_IsoMu27orMu50_pt_eta_pass->Sumw2();
*/
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      bool tag_Mu37_TkMu27_leg1 = passFilterMu37_TkMu27_leg1->at(first);

      if(!(tag_MuId && tag_MuKin && tag_TriggerMatch_monoH))continue;

      //bool probe_MuId = HWW_Muon_Def(second, mu_pt->at(second));
      bool probe_MuId = HWW_Muon_18(second, mu_pt->at(second));
      ...
      if (Z_candLV.M()<zMassL || Z_candLV.M() >zMassR) continue;
       ...
       if(tag_Mu37_TkMu27_leg1) {
       h_Mu37_TkMu27_leg2_pt_total->Fill(mu_pt->at(second)); 
       if(mu_pt->at(second)>30)h_Mu37_TkMu27_leg2_eta_total->Fill(mu_eta->at(second)); 
       h_Mu37_TkMu27_leg2_pt_eta_total->Fill(mu_eta->at(second),mu_pt->at(second)); 

       if (passFilterMu37_TkMu27_leg2->at(second) ){
       h_Mu37_TkMu27_leg2_pt_pass->Fill(mu_pt->at(second)); 
       if(mu_pt->at(second)>30) h_Mu37_TkMu27_leg2_eta_pass->Fill(mu_eta->at(second)); 
       h_Mu37_TkMu27_leg2_pt_eta_pass->Fill(mu_eta->at(second),mu_pt->at(second)); 
       } 
...
/*
      h_orTag_IsoMu27_pt_total->Fill(mu_pt->at(second)); 
      if(mu_pt->at(second)>30)h_orTag_IsoMu27_eta_total->Fill(mu_eta->at(second)); 
      h_orTag_IsoMu27_pt_eta_total->Fill(mu_eta->at(second),mu_pt->at(second)); 
      ...
      h_orTag_IsoMu27_pt_pass->Fill(mu_pt->at(second)); 
     if(mu_pt->at(second)>30) h_orTag_IsoMu27_eta_pass->Fill(mu_eta->at(second)); 
      h_orTag_IsoMu27_pt_eta_pass->Fill(mu_eta->at(second),mu_pt->at(second)); 
      } 
     ...
     if(mu_pt->at(second)>12) h_orTag_Mu17_Mu8_leg2_eta_Iso_pass->Fill(mu_eta->at(second)); 
      ...
      // MonoHiggs
      h_orTag_IsoMu27orMu50_pt_total->Fill(mu_pt->at(second)); 
      if(mu_pt->at(second)>30)h_orTag_IsoMu27orMu50_eta_total->Fill(mu_eta->at(second)); 
      h_orTag_IsoMu27orMu50_pt_eta_total->Fill(mu_eta->at(second),mu_pt->at(second)); 
      ...
      h_orTag_IsoMu27orMu50_pt_pass->Fill(mu_pt->at(second)); 
      if(mu_pt->at(second)>30) h_orTag_IsoMu27orMu50_eta_pass->Fill(mu_eta->at(second)); 
      h_orTag_IsoMu27orMu50_pt_eta_pass->Fill(mu_eta->at(second),mu_pt->at(second)); 
      } 
...
*/
     ...
     // h_Mu17_pt_total->Fill(mu_pt->at(second)); 
     // if(mu_pt->at(second)>30)h_Mu17_eta_total->Fill(mu_eta->at(second)); 
     // h_Mu17_pt_eta_total->Fill(mu_eta->at(second),mu_pt->at(second)); 

     // if (passFilterMu17->at(second) ){
     // h_Mu17_pt_pass->Fill(mu_pt->at(second)); 
     // if(mu_pt->at(second)>30) h_Mu17_eta_pass->Fill(mu_eta->at(second)); 
     // h_Mu17_pt_eta_pass->Fill(mu_eta->at(second),mu_pt->at(second)); 
     // } 
      ...
      h_Mu37_TkMu27_leg1_pt_total->Fill(mu_pt->at(second)); 
      if(mu_pt->at(second)>30)h_Mu37_TkMu27_leg1_eta_total->Fill(mu_eta->at(second)); 
      h_Mu37_TkMu27_leg1_pt_eta_total->Fill(mu_eta->at(second),mu_pt->at(second)); 

      if (passFilterMu37_TkMu27_leg1->at(second) ){
      h_Mu37_TkMu27_leg1_pt_pass->Fill(mu_pt->at(second)); 
      if(mu_pt->at(second)>30) h_Mu37_TkMu27_leg1_eta_pass->Fill(mu_eta->at(second)); 
      h_Mu37_TkMu27_leg1_pt_eta_pass->Fill(mu_eta->at(second),mu_pt->at(second)); 
      } 
...
bool TagAndProbe::HWW_Muon_18(int i, double pt)
{
    bool tightMu = mu_CutBasedIdTight->at(i);   // should be tight
    bool passIsoTight = mu_PFIsoTight->at(i);
    bool pass_dz = mu_dz->at(i) < 0.1;
