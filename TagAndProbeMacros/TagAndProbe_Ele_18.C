#define TagAndProbe_18_cxx
#include "TagAndProbe_18.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void TagAndProbe_18::Loop(TString output)
{
//   In a ROOT session, you can do:
//      root> .L TagAndProbe_18.C
//      root> TagAndProbe_18 t
...
*/
   ...
   //for (Long64_t jentry=0; jentry<10;jentry++) {
      ...
      bool probe_EleId = HWW_Electron_18(second, ele_etaSC->at(second));
...
bool TagAndProbe_18::HWW_Electron_18(int i, double eta)
{
    ...
    if (!pass_mvaFall17Iso_WP90) return false;
...
bool TagAndProbe_18::HWW_Electron_17v5(int i, double eta)
{
    double sieie = ele_full5x5_sigmaIetaIeta->at(i);
    double eInvMinusPInv = ele_ooEmooP->at(i);
    bool pass_mvaFall17Iso_WP90 = passMVAIsoWP90->at(i);
...
bool TagAndProbe_18::HWW_Electron_Def(int i, double eta)
{
...
bool TagAndProbe_18::HWW_Electron_NewDef(int i, double eta)
{
