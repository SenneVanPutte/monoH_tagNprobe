...
for(int i=0; i<systematicVar.size();i++)
{
   ...
   double pt_bins_Ele27[18] =            {0,10,20,24,25,26,27,28,29,30,35,40,45,50,60,100,200};
   ...
   // MonoHiggs
   double pt_bins_DoubleEle33[18] = {0,10,20,25,30,31,32,33,34,35,36,40,45,50,60,100,200};
   ...
   double pt_bins_Mu27_Ele37_legEle[18] = {0,10,20,30,34,35,36,37,38,39,40,42,45,50,60,100,200};
   double pt_bins_Mu37_Ele27_legEle[18] = {0,10,20,24,25,26,27,28,29,30,32,35,40,50,60,100,200};
   double pt_bins_Mu33_Ele33_legEle[18] = {0,10,20,25,30,31,32,33,34,35,36,40,45,50,60,100,200};

// HLT Ele27
   TH1F *h_Ele27_pt_total = new TH1F("Ele27_pt_total","Ele27_pt",16,pt_bins_Ele27);
   TH1F *h_Ele27_eta_total = new TH1F("Ele27_eta_total","Ele27_eta",10,eta_bins);
   TH2F *h_Ele27_pt_eta_total = new TH2F("Ele27_pt_eta_total","Ele27_pt_eta",10,eta_bins,16,pt_bins_Ele27);
   TH1F *h_Ele27_pt_pass = new TH1F("Ele27_pt_pass","Ele27_pt",16,pt_bins_Ele27);
   TH1F *h_Ele27_eta_pass = new TH1F("Ele27_eta_pass","Ele27_eta",10,eta_bins);
   TH2F *h_Ele27_pt_eta_pass = new TH2F("Ele27_pt_eta_pass","Ele27_pt_eta",10,eta_bins,16,pt_bins_Ele27);
...
*/
// MonoHiggs
   TH1F *h_DoubleEle33_MW_leg_pt_total = new TH1F("DoubleEle33_MW_leg_pt_total","DoubleEle33_MW_leg_pt",16,pt_bins_DoubleEle33);
   TH1F *h_DoubleEle33_MW_leg_eta_total = new TH1F("DoubleEle33_MW_leg_eta_total","DoubleEle33_MW_leg_eta",10,eta_bins);
   TH2F *h_DoubleEle33_MW_leg_pt_eta_total = new TH2F("DoubleEle33_MW_leg_pt_eta_total","DoubleEle33_MW_leg_pt_eta",10,eta_bins,16,pt_bins_DoubleEle33);
   TH1F *h_DoubleEle33_MW_leg_pt_pass = new TH1F("DoubleEle33_MW_leg_pt_pass","DoubleEle33_MW_leg_pt",16,pt_bins_DoubleEle33);
   TH1F *h_DoubleEle33_MW_leg_eta_pass = new TH1F("DoubleEle33_MW_leg_eta_pass","DoubleEle33_MW_leg_eta",10,eta_bins);
   TH2F *h_DoubleEle33_MW_leg_pt_eta_pass = new TH2F("DoubleEle33_MW_leg_pt_eta_pass","DoubleEle33_MW_leg_pt_eta",10,eta_bins,16,pt_bins_DoubleEle33);

   h_DoubleEle33_MW_leg_pt_total->Sumw2();
   h_DoubleEle33_MW_leg_eta_total->Sumw2();
   h_DoubleEle33_MW_leg_pt_eta_total->Sumw2();
   h_DoubleEle33_MW_leg_pt_pass->Sumw2();
   h_DoubleEle33_MW_leg_eta_pass->Sumw2();
   h_DoubleEle33_MW_leg_pt_eta_pass->Sumw2();

   TH1F *h_DoubleEle33_GsfTrkIdVL_leg_pt_total = new TH1F("DoubleEle33_GsfTrkIdVL_leg_pt_total","DoubleEle33_GsfTrkIdVL_leg_pt",16,pt_bins_DoubleEle33);
   TH1F *h_DoubleEle33_GsfTrkIdVL_leg_eta_total = new TH1F("DoubleEle33_GsfTrkIdVL_leg_eta_total","DoubleEle33_GsfTrkIdVL_leg_eta",10,eta_bins);
   TH2F *h_DoubleEle33_GsfTrkIdVL_leg_pt_eta_total = new TH2F("DoubleEle33_GsfTrkIdVL_leg_pt_eta_total","DoubleEle33_GsfTrkIdVL_leg_pt_eta",10,eta_bins,16,pt_bins_DoubleEle33);
   TH1F *h_DoubleEle33_GsfTrkIdVL_leg_pt_pass = new TH1F("DoubleEle33_GsfTrkIdVL_leg_pt_pass","DoubleEle33_GsfTrkIdVL_leg_pt",16,pt_bins_DoubleEle33);
   TH1F *h_DoubleEle33_GsfTrkIdVL_leg_eta_pass = new TH1F("DoubleEle33_GsfTrkIdVL_leg_eta_pass","DoubleEle33_GsfTrkIdVL_leg_eta",10,eta_bins);
   TH2F *h_DoubleEle33_GsfTrkIdVL_leg_pt_eta_pass = new TH2F("DoubleEle33_GsfTrkIdVL_leg_pt_eta_pass","DoubleEle33_GsfTrkIdVL_leg_pt_eta",10,eta_bins,16,pt_bins_DoubleEle33);

   h_DoubleEle33_GsfTrkIdVL_leg_pt_total->Sumw2();
   h_DoubleEle33_GsfTrkIdVL_leg_eta_total->Sumw2();
   h_DoubleEle33_GsfTrkIdVL_leg_pt_eta_total->Sumw2();
   h_DoubleEle33_GsfTrkIdVL_leg_pt_pass->Sumw2();
   h_DoubleEle33_GsfTrkIdVL_leg_eta_pass->Sumw2();
   h_DoubleEle33_GsfTrkIdVL_leg_pt_eta_pass->Sumw2();

   TH1F *h_DoubleEle33_GsfTrkIdVL_MW_leg_pt_total = new TH1F("DoubleEle33_GsfTrkIdVL_MW_leg_pt_total","DoubleEle33_GsfTrkIdVL_MW_leg_pt",16,pt_bins_DoubleEle33);
   TH1F *h_DoubleEle33_GsfTrkIdVL_MW_leg_eta_total = new TH1F("DoubleEle33_GsfTrkIdVL_MW_leg_eta_total","DoubleEle33_GsfTrkIdVL_MW_leg_eta",10,eta_bins);
   TH2F *h_DoubleEle33_GsfTrkIdVL_MW_leg_pt_eta_total = new TH2F("DoubleEle33_GsfTrkIdVL_MW_leg_pt_eta_total","DoubleEle33_GsfTrkIdVL_MW_leg_pt_eta",10,eta_bins,16,pt_bins_DoubleEle33);
   TH1F *h_DoubleEle33_GsfTrkIdVL_MW_leg_pt_pass = new TH1F("DoubleEle33_GsfTrkIdVL_MW_leg_pt_pass","DoubleEle33_GsfTrkIdVL_MW_leg_pt",16,pt_bins_DoubleEle33);
   TH1F *h_DoubleEle33_GsfTrkIdVL_MW_leg_eta_pass = new TH1F("DoubleEle33_GsfTrkIdVL_MW_leg_eta_pass","DoubleEle33_GsfTrkIdVL_MW_leg_eta",10,eta_bins);
   TH2F *h_DoubleEle33_GsfTrkIdVL_MW_leg_pt_eta_pass = new TH2F("DoubleEle33_GsfTrkIdVL_MW_leg_pt_eta_pass","DoubleEle33_GsfTrkIdVL_MW_leg_pt_eta",10,eta_bins,16,pt_bins_DoubleEle33);

   h_DoubleEle33_GsfTrkIdVL_MW_leg_pt_total->Sumw2();
   h_DoubleEle33_GsfTrkIdVL_MW_leg_eta_total->Sumw2();
   h_DoubleEle33_GsfTrkIdVL_MW_leg_pt_eta_total->Sumw2();
   h_DoubleEle33_GsfTrkIdVL_MW_leg_pt_pass->Sumw2();
   h_DoubleEle33_GsfTrkIdVL_MW_leg_eta_pass->Sumw2();
   h_DoubleEle33_GsfTrkIdVL_MW_leg_pt_eta_pass->Sumw2();
/*   
...
*/
   ...
   TH1F *h_Mu27_Ele37_emu_legEle_pt_total = new TH1F("Mu27_Ele37_emu_legEle_pt_total","Mu27_Ele37_emu_legEle_pt",16,pt_bins_Ele27_Ele37_leg1);
   TH1F *h_Mu27_Ele37_emu_legEle_eta_total = new TH1F("Mu27_Ele37_emu_legEle_eta_total","Mu27_Ele37_emu_legEle_eta",10,eta_bins);
   TH2F *h_Mu27_Ele37_emu_legEle_pt_eta_total = new TH2F("Mu27_Ele37_emu_legEle_pt_eta_total","Mu27_Ele37_emu_legEle_pt_eta",10,eta_bins,16,pt_bins_Ele27_Ele37_leg1);
   TH1F *h_Mu27_Ele37_emu_legEle_pt_pass = new TH1F("Mu27_Ele37_emu_legEle_pt_pass","Mu27_Ele37_emu_legEle_pt",16,pt_bins_Ele27_Ele37_leg1);
   TH1F *h_Mu27_Ele37_emu_legEle_eta_pass = new TH1F("Mu27_Ele37_emu_legEle_eta_pass","Mu27_Ele37_emu_legEle_eta",10,eta_bins);
   TH2F *h_Mu27_Ele37_emu_legEle_pt_eta_pass = new TH2F("Mu27_Ele37_emu_legEle_pt_eta_pass","Mu27_Ele37_emu_legEle_pt_eta",10,eta_bins,16,pt_bins_Ele27_Ele37_leg1);

   h_Mu27_Ele37_emu_legEle_pt_total->Sumw2();
   h_Mu27_Ele37_emu_legEle_eta_total->Sumw2();
   h_Mu27_Ele37_emu_legEle_pt_eta_total->Sumw2();
   h_Mu27_Ele37_emu_legEle_pt_pass->Sumw2();
   h_Mu27_Ele37_emu_legEle_eta_pass->Sumw2();
   h_Mu27_Ele37_emu_legEle_pt_eta_pass->Sumw2();
   ...
   TH1F *h_Mu33_Ele33_legEle_pt_total = new TH1F("Mu33_Ele33_legEle_pt_total","Mu33_Ele33_legEle_pt",16,pt_bins_Mu33_Ele33_legEle);
   TH1F *h_Mu33_Ele33_legEle_eta_total = new TH1F("Mu33_Ele33_legEle_eta_total","Mu33_Ele33_legEle_eta",10,eta_bins);
   TH2F *h_Mu33_Ele33_legEle_pt_eta_total = new TH2F("Mu33_Ele33_legEle_pt_eta_total","Mu33_Ele33_legEle_pt_eta",10,eta_bins,16,pt_bins_Mu33_Ele33_legEle);
   TH1F *h_Mu33_Ele33_legEle_pt_pass = new TH1F("Mu33_Ele33_legEle_pt_pass","Mu33_Ele33_legEle_pt",16,pt_bins_Mu33_Ele33_legEle);
   TH1F *h_Mu33_Ele33_legEle_eta_pass = new TH1F("Mu33_Ele33_legEle_eta_pass","Mu33_Ele33_legEle_eta",10,eta_bins);
   TH2F *h_Mu33_Ele33_legEle_pt_eta_pass = new TH2F("Mu33_Ele33_legEle_pt_eta_pass","Mu33_Ele33_legEle_pt_eta",10,eta_bins,16,pt_bins_Mu33_Ele33_legEle);

   h_Mu33_Ele33_legEle_pt_total->Sumw2();
   h_Mu33_Ele33_legEle_eta_total->Sumw2();
   h_Mu33_Ele33_legEle_pt_eta_total->Sumw2();
   h_Mu33_Ele33_legEle_pt_pass->Sumw2();
   h_Mu33_Ele33_legEle_eta_pass->Sumw2();
   h_Mu33_Ele33_legEle_pt_eta_pass->Sumw2();
   ...
   //for (Long64_t jentry=0; jentry<10;jentry++) {
      ...
      bool tag_EleId = passCutBasedIdTightSum16->at(first);
      bool tag_EleKin = ele_pt->at(first)>ptTag && fabs(ele_etaSC->at(first))<2.5;
      bool tag_TriggerMatch = passFilterEle27->at(first);

      // MonoHiggs
      // bool tag_TriggerMatch_monoH = passFilterEle27->at(first) || passFilter_monoHSingleEle->at(first);

      if(!(tag_EleId && tag_EleKin && tag_TriggerMatch))continue;

      //bool probe_EleId = HWW_Electron_Def(second, ele_etaSC->at(second));
      bool probe_EleId = HWW_Electron_2016(second, ele_etaSC->at(second));
      ...
      if(ele_pt->at(second)>40)h_Ele27_eta_total->Fill(ele_etaSC->at(second)); 
...
*/
      ...
      if(ele_pt->at(second)>40)h_Ele27_eta_pass->Fill(ele_etaSC->at(second)); 
...
*/
      ...
      h_DoubleEle33_MW_leg_pt_total->Fill(ele_pt->at(second)); 
      if(ele_pt->at(second)>40)h_DoubleEle33_MW_leg_eta_total->Fill(ele_etaSC->at(second)); 
      h_DoubleEle33_MW_leg_pt_eta_total->Fill(ele_etaSC->at(second),ele_pt->at(second)); 

      h_DoubleEle33_GsfTrkIdVL_leg_pt_total->Fill(ele_pt->at(second)); 
      if(ele_pt->at(second)>40)h_DoubleEle33_GsfTrkIdVL_leg_eta_total->Fill(ele_etaSC->at(second)); 
      h_DoubleEle33_GsfTrkIdVL_leg_pt_eta_total->Fill(ele_etaSC->at(second),ele_pt->at(second)); 

      h_DoubleEle33_GsfTrkIdVL_MW_leg_pt_total->Fill(ele_pt->at(second)); 
      if(ele_pt->at(second)>40)h_DoubleEle33_GsfTrkIdVL_MW_leg_eta_total->Fill(ele_etaSC->at(second)); 
      h_DoubleEle33_GsfTrkIdVL_MW_leg_pt_eta_total->Fill(ele_etaSC->at(second),ele_pt->at(second)); 
/*
...
*/
      ...
      h_Mu27_Ele37_emu_legEle_pt_total->Fill(ele_pt->at(second)); 
      if(ele_pt->at(second)>40)h_Mu27_Ele37_emu_legEle_eta_total->Fill(ele_etaSC->at(second)); 
      h_Mu27_Ele37_emu_legEle_pt_eta_total->Fill(ele_etaSC->at(second),ele_pt->at(second)); 
      ...
      h_Mu33_Ele33_legEle_pt_total->Fill(ele_pt->at(second)); 
      if(ele_pt->at(second)>40)h_Mu33_Ele33_legEle_eta_total->Fill(ele_etaSC->at(second)); 
      h_Mu33_Ele33_legEle_pt_eta_total->Fill(ele_etaSC->at(second),ele_pt->at(second)); 
...
*/
      ...
      if (passFilterDoubleEle33_MW_leg->at(second)){
      h_DoubleEle33_MW_leg_pt_pass->Fill(ele_pt->at(second)); 
      if(ele_pt->at(second)>40)h_DoubleEle33_MW_leg_eta_pass->Fill(ele_etaSC->at(second)); 
      h_DoubleEle33_MW_leg_pt_eta_pass->Fill(ele_etaSC->at(second),ele_pt->at(second)); 
      } 

      if (passFilterDoubleEle33_GsfTrkIdVL_leg->at(second)){
      h_DoubleEle33_GsfTrkIdVL_leg_pt_pass->Fill(ele_pt->at(second)); 
      if(ele_pt->at(second)>40)h_DoubleEle33_GsfTrkIdVL_leg_eta_pass->Fill(ele_etaSC->at(second)); 
      h_DoubleEle33_GsfTrkIdVL_leg_pt_eta_pass->Fill(ele_etaSC->at(second),ele_pt->at(second)); 
      } 

      if (passFilterDoubleEle33_GsfTrkIdVL_MW_leg->at(second)){
      h_DoubleEle33_GsfTrkIdVL_MW_leg_pt_pass->Fill(ele_pt->at(second)); 
      if(ele_pt->at(second)>40)h_DoubleEle33_GsfTrkIdVL_MW_leg_eta_pass->Fill(ele_etaSC->at(second)); 
      h_DoubleEle33_GsfTrkIdVL_MW_leg_pt_eta_pass->Fill(ele_etaSC->at(second),ele_pt->at(second)); 
      } 
/*
...
*/
      ...
      if (passFilterMu27_Ele37_emu_legEle->at(second)){
      h_Mu27_Ele37_emu_legEle_pt_pass->Fill(ele_pt->at(second)); 
      if(ele_pt->at(second)>40)h_Mu27_Ele37_emu_legEle_eta_pass->Fill(ele_etaSC->at(second)); 
      h_Mu27_Ele37_emu_legEle_pt_eta_pass->Fill(ele_etaSC->at(second),ele_pt->at(second)); 
      } 
      ...
      if (passFilterMu33_Ele33_legEle->at(second)){
      h_Mu33_Ele33_legEle_pt_pass->Fill(ele_pt->at(second)); 
      if(ele_pt->at(second)>40)h_Mu33_Ele33_legEle_eta_pass->Fill(ele_etaSC->at(second)); 
      h_Mu33_Ele33_legEle_pt_eta_pass->Fill(ele_etaSC->at(second),ele_pt->at(second)); 
      } 

/*
      if (passFilterDoubleEle33_MW_leg->at(second) || passFilterEle23_12_leg1->at(second)){
      ...
      if (passFilterDoubleEle33_MW_leg->at(second) || passFilterEle23_12_leg2->at(second)){
...
bool TagAndProbe_16::HWW_Electron_Def(int i, double eta)
{
...
bool TagAndProbe_16::HWW_Electron_NewDef(int i, double eta)
{
...
bool TagAndProbe_16::HWW_Electron_2016(int i, double eta)
{
...
double lostHits = ele_expectedMissingInnerHits->at(i);
bool cutBased_HLTPreSel = passCutBasedIdHLT->at(i);
bool cutBased_tightSum16 = passCutBasedIdTightSum16->at(i);

if (fabs(eta) > 2.5){
    return false;
} else if(fabs(eta) < 1.479){    // Barrel
    // Loose
    if (!cutBased_HLTPreSel) return false;
    if (lostHits >= 2) return false;
    // Tight
    if (!cutBased_tightSum16) return false;
    if (ele_d0->at(i)>=0.05) return false;
    if (ele_dz->at(i)>=0.1) return false;
} else{
    // Loose
