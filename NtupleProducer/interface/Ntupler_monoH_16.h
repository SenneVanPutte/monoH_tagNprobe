#ifndef Ntupler_monoH_16_h
#define Ntupler_monoH_16_h
...
class Ntupler_monoH_16 : public edm::EDAnalyzer {
   public:
      explicit Ntupler_monoH_16(const edm::ParameterSet&);
      ~Ntupler_monoH_16();
   ...
   private:
     ...
     // 2016
     edm::EDGetTokenT<edm::ValueMap<bool> > cutBasedIdTightSum16_token_;
     edm::EDGetTokenT<edm::ValueMap<bool> > cutBasedIdHLT_token_;
  ...
  // Trigger names and decision 
     ...
     // 2016     
     std::vector<bool> passCutBasedIdTightSum16_;
     std::vector<bool> passCutBasedIdHLT_;
     std::vector<bool> passFilterEle27;

     // MonoHiggs
     std::vector<bool> passFilterDoubleEle33_MW_leg;
     std::vector<bool> passFilterDoubleEle33_GsfTrkIdVL_leg;
     std::vector<bool> passFilterDoubleEle33_GsfTrkIdVL_MW_leg;
     std::vector<bool> passFilterMu27_Ele37_legEle;
     std::vector<bool> passFilterMu27_Ele37_emu_legEle;
     std::vector<bool> passFilterMu37_Ele27_legEle;

     std::vector<bool> passFilterMu33_Ele33_legEle;
     ...
     std::vector<double> ele_CutBasedIdTight_;
    ...
    // All Muon variables 
     ...
     std::vector<bool> passFilterMu30_TkMu11_leg1;
     std::vector<bool> passFilterMu30_TkMu11_leg2;
     std::vector<bool> passFilterMu27_Ele37_legMu;
     std::vector<bool> passFilterMu37_Ele27_legMu;

     std::vector<bool> passFilterMu33_Ele33_legMu;
     std::vector<bool> passFilterMu33_Ele33_emu_legMu;
