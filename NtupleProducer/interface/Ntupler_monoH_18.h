#ifndef Ntupler_monoH_18_h
#define Ntupler_monoH_18_h
...
class Ntupler_monoH_18 : public edm::EDAnalyzer {
   public:
      explicit Ntupler_monoH_18(const edm::ParameterSet&);
      ~Ntupler_monoH_18();
  ...
  // Trigger names and decision 
     ...
     // MonoHiggs
     //std::vector<bool> passFilterDoubleEle33;
     std::vector<bool> passFilterDoubleEle33_leg;
     std::vector<bool> passFilterDoubleEle27_leg;
     std::vector<bool> passFilterDoubleEle25_leg;
     std::vector<bool> passFilterEle27_37_leg1;
     std::vector<bool> passFilterEle27_37_leg2;
    ...
    // All Muon variables 
     ...
     // MonoHiggs
     //std::vector<bool> passFilterMu17;
     std::vector<bool> passFilterMu50;
     std::vector<bool> passFilterMu37_TkMu27_leg1;
     std::vector<bool> passFilterMu37_TkMu27_leg2;
     std::vector<bool> passFilterMu27_Ele37_legMu;
     std::vector<bool> passFilterMu37_Ele27_legMu;
     std::vector<bool> passFilterMu27_Ele37_16L1_legMu;
     std::vector<bool> passFilterMu37_Ele27_16L1_legMu;
