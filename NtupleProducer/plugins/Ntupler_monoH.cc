#include "TagAndProbe_Trigger/NtupleProducer/interface/Ntupler_monoH.h"
...
//
Ntupler_monoH::Ntupler_monoH(const edm::ParameterSet& iConfig):
...
void
Ntupler_monoH::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  using namespace std;
  using namespace edm;
...
void 
Ntupler_monoH::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
Ntupler_monoH::endJob() 
{
}
...
/*
void 
Ntupler_monoH::beginRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void 
Ntupler_monoH::endRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void 
Ntupler_monoH::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
/*
void 
Ntupler_monoH::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
void
Ntupler_monoH::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
int Ntupler_monoH::matchToTruth(const edm::Ptr<reco::GsfElectron> el, 
  ...
  if( ancestorPID == -999 && ancestorStatus == -999 ){
    ...
    // Complain.
    printf("Ntupler_monoH: ERROR! Electron does not apper to have a non-electron parent\n");
    return UNMATCHED;
  }
...
bool Ntupler_monoH::cmd(const reco::GenParticle & s1, const reco::GenParticle & s2)
{  
   return s1.pt() > s2.pt();
}

void Ntupler_monoH::findFirstNonElectronMother(const reco::Candidate *particle,
						 int &ancestorPID, int &ancestorStatus){

  if( particle == 0 ){
    printf("Ntupler_monoH: ERROR! null candidate pointer, this should never happen\n");
    return;
  }
...
bool
Ntupler_monoH::hasWZasMother(const reco::GenParticle  p)  
{
    bool foundZ = false;
...
/*void Ntupler_monoH::printCutFlowResult(vid::CutFlowResult &cutflow){
...
DEFINE_FWK_MODULE(Ntupler_monoH);
